...
public class Tuple2<T0, T1> implements Serializable {
  ...
  public static class NonFinal<T0, T1> implements Serializable {
     ...
     * @param value1 The value for field 1
     */
    public NonFinal(T0 value0, T1 value1) {
      this.f0 = value0;
      this.f1 = value1;
    }
    ...
    public boolean equals(Object o) {
      ...
      Tuple2.NonFinal<?, ?> tuple2 = (Tuple2.NonFinal<?, ?>) o;
  ...
  public static <T0, T1> Tuple2.NonFinal<T0, T1> ofNonFinal(T0 value0, T1 value1) {
    return new Tuple2.NonFinal<>(value0, value1);
  }
