...
public class Types {
  ...
  /**
   * enum: a data type consisting of a set of named values. Rust enum with non-predefined field values are not \
   * supported as an enum.
   */
  ...
  /**
   * a type which is not morphic(not final). i.e. it don't have subclasses. Suppose we're deserializing
