...
public class MapFlags {
     ...
     */
    public static int KEY_NOT_SAME_TYPE = 0b1000;

    /**
     * Whether track value ref.
     */
    public static int TRACKING_VALUE_REF = 0b10000;

    /**
     * Whether value has null.
     */
    public static int VALUE_HAS_NULL = 0b100000;
     ...
     */
    public static int VALUE_NOT_SAME_TYPE = 0b10000000;
