...
import io.fury.format.vectorized.ArrowTableSerializer;
import io.fury.format.vectorized.ArrowUtilsTest;
...
public class ArrowSerializersTest {
  ...
  public void testWriteVectorSchemaRoot() throws IOException {
    ...
    int size = 2000;
    VectorSchemaRoot root = io.fury.format.vectorized.ArrowUtilsTest.createVectorSchemaRoot(size);
    Assert.assertEquals(
