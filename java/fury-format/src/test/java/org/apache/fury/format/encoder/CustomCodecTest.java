...
public class CustomCodecTest {
  ...
  static {
    ...
    Encoders.registerCustomCollectionFactory(SortedSet.class, UUID.class, new SortedSetOfUuidDecoder());
  }
  ...
  private enum UnsignedUuidComparator implements Comparator<UUID> {
    ...
    public int compare(final UUID o1, final UUID o2) {
      final int cmpMsb = Long.compareUnsigned(o1.getMostSignificantBits(), o2.getMostSignificantBits());
      if (cmpMsb != 0) {
        return cmpMsb;
      }
