...
public class Encoders {
   ...
   */
  public static <T> void registerCustomCodec(Class<?> beanType, Class<T> type, CustomCodec<T, ?> codec) {
   ...
   */
  public static <E, C extends Collection<E>> void registerCustomCollectionFactory(Class<?> collectionType, Class<E> elementType, CustomCollectionFactory<E, C> factory) {
