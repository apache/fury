...
public interface CustomTypeHandler extends CustomTypeRegistry {
    static final CustomTypeHandler EMPTY = new CustomTypeHandler() {
        @Override
        ...
        @Override
        public CustomCollectionFactory<?, ?> findCollectionFactory(final Class<?> collectionType, final Class<?> elementType) {
            return null;
        }
    };

    <T> CustomCodec<T, ?> findCodec(Class<?> beanType, Class<T> fieldType);
    CustomCollectionFactory<?, ?> findCollectionFactory(Class<?> collectionType, Class<?> elementType);
    ...
    @Override
    default boolean canConstructCollection(final Class<?> collectionType, final Class<?> elementType) {
