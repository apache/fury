...
//
//     public VectorSchemaRootSerializer(Fury fury, Class<VectorSchemaRoot> cls) {
//       this(fury, cls, defaultAllocator);
//     }
//
//     public VectorSchemaRootSerializer(
//         Fury fury, Class<VectorSchemaRoot> cls, BufferAllocator allocator) {
//       super(fury, cls, Type.FURY_ARROW_RECORD_BATCH.getId());
