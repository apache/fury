...
//
//   public ArrowTableSerializer(Fury fury, Class<ArrowTable> cls) {
//     this(fury, cls, defaultAllocator);
//   }
//
//   public ArrowTableSerializer(Fury fury, Class<ArrowTable> cls, BufferAllocator allocator) {
//     super(fury, cls, Type.FURY_ARROW_TABLE.getId());
