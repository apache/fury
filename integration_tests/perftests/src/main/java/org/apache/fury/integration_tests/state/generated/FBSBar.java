...
public final class FBSBar extends Table {
  ...
  public org.apache.fury.integration_tests.state.generated.FBSFoo f1() { return f1(new org.apache.fury.integration_tests.state.generated.FBSFoo()); }
  public org.apache.fury.integration_tests.state.generated.FBSFoo f1(org.apache.fury.integration_tests.state.generated.FBSFoo obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public org.apache.fury.integration_tests.state.generated.FBSFoo f3(int j) { return f3(new org.apache.fury.integration_tests.state.generated.FBSFoo(), j); }
  public org.apache.fury.integration_tests.state.generated.FBSFoo f3(org.apache.fury.integration_tests.state.generated.FBSFoo obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int f3Length() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public org.apache.fury.integration_tests.state.generated.FBSFoo.Vector f3Vector() { return f3Vector(new org.apache.fury.integration_tests.state.generated.FBSFoo.Vector()); }
  public org.apache.fury.integration_tests.state.generated.FBSFoo.Vector f3Vector(org.apache.fury.integration_tests.state.generated.FBSFoo.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public org.apache.fury.integration_tests.state.generated.FBSFoo f4Value(int j) { return f4Value(new org.apache.fury.integration_tests.state.generated.FBSFoo(), j); }
  public org.apache.fury.integration_tests.state.generated.FBSFoo f4Value(org.apache.fury.integration_tests.state.generated.FBSFoo obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int f4ValueLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public org.apache.fury.integration_tests.state.generated.FBSFoo.Vector f4ValueVector() { return f4ValueVector(new org.apache.fury.integration_tests.state.generated.FBSFoo.Vector()); }
  public org.apache.fury.integration_tests.state.generated.FBSFoo.Vector f4ValueVector(org.apache.fury.integration_tests.state.generated.FBSFoo.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
