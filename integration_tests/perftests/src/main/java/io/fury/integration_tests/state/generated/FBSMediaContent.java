...
public final class FBSMediaContent extends Table {
  ...
  public org.apache.fury.integration_tests.state.generated.FBSMedia media() { return media(new org.apache.fury.integration_tests.state.generated.FBSMedia()); }
  public org.apache.fury.integration_tests.state.generated.FBSMedia media(org.apache.fury.integration_tests.state.generated.FBSMedia obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public org.apache.fury.integration_tests.state.generated.FBSImage images(int j) { return images(new org.apache.fury.integration_tests.state.generated.FBSImage(), j); }
  public org.apache.fury.integration_tests.state.generated.FBSImage images(org.apache.fury.integration_tests.state.generated.FBSImage obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int imagesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public org.apache.fury.integration_tests.state.generated.FBSImage.Vector imagesVector() { return imagesVector(new org.apache.fury.integration_tests.state.generated.FBSImage.Vector()); }
  public org.apache.fury.integration_tests.state.generated.FBSImage.Vector imagesVector(org.apache.fury.integration_tests.state.generated.FBSImage.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
