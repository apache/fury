...
public final class FBSMediaContent extends Table {
  ...
  public io.fury.integration_tests.state.generated.FBSMedia media(io.fury.integration_tests.state.generated.FBSMedia obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public io.fury.integration_tests.state.generated.FBSImage images(int j) { return images(new io.fury.integration_tests.state.generated.FBSImage(), j); }
  public io.fury.integration_tests.state.generated.FBSImage images(io.fury.integration_tests.state.generated.FBSImage obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int imagesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public io.fury.integration_tests.state.generated.FBSImage.Vector imagesVector() { return imagesVector(new io.fury.integration_tests.state.generated.FBSImage.Vector()); }
  public io.fury.integration_tests.state.generated.FBSImage.Vector imagesVector(io.fury.integration_tests.state.generated.FBSImage.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
