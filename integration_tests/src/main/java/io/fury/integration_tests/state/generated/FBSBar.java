...
public final class FBSBar extends Table {
  ...
  public io.fury.integration_tests.state.generated.FBSFoo f1() { return f1(new io.fury.integration_tests.state.generated.FBSFoo()); }
  public io.fury.integration_tests.state.generated.FBSFoo f1(io.fury.integration_tests.state.generated.FBSFoo obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public io.fury.integration_tests.state.generated.FBSFoo f3(int j) { return f3(new io.fury.integration_tests.state.generated.FBSFoo(), j); }
  public io.fury.integration_tests.state.generated.FBSFoo f3(io.fury.integration_tests.state.generated.FBSFoo obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int f3Length() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public io.fury.integration_tests.state.generated.FBSFoo.Vector f3Vector() { return f3Vector(new io.fury.integration_tests.state.generated.FBSFoo.Vector()); }
  public io.fury.integration_tests.state.generated.FBSFoo.Vector f3Vector(io.fury.integration_tests.state.generated.FBSFoo.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public io.fury.integration_tests.state.generated.FBSFoo f4Value(int j) { return f4Value(new io.fury.integration_tests.state.generated.FBSFoo(), j); }
  public io.fury.integration_tests.state.generated.FBSFoo f4Value(io.fury.integration_tests.state.generated.FBSFoo obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int f4ValueLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public io.fury.integration_tests.state.generated.FBSFoo.Vector f4ValueVector() { return f4ValueVector(new io.fury.integration_tests.state.generated.FBSFoo.Vector()); }
  public io.fury.integration_tests.state.generated.FBSFoo.Vector f4ValueVector(io.fury.integration_tests.state.generated.FBSFoo.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
