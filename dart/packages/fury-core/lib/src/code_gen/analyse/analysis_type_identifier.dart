...
import 'package:fury_core/src/code_gen/collection/key/type_3string_key.dart';
...
class AnalysisTypeIdentifier{
  ...
  static final List<Type3StringKey> _keys = [
    ...
    //   'FuryOne',
    //   'package',
    //   'fury_core/src/annotation/fury_one.dart',
    // ),
    Type3StringKey(
      'FuryClass',
      'package',
      'fury_core/src/annotation/fury_class.dart',
    ),
    Type3StringKey(
      'FuryKey',
      'package',
      'fury_core/src/annotation/fury_key.dart',
    ),
    Type3StringKey(
      'FuryCons',
      'package',
      'fury_core/src/annotation/fury_cons.dart',
    ),
    Type3StringKey(
      'FuryEnum',
      'package',
      'fury_core/src/annotation/fury_enum.dart',
    ),
  ];
  ...
  // anno.computeConstantValue()!.type!.element!
