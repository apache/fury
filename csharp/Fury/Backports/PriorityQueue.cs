...
namespace System.Collections.Generic
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        {
            ThrowHelper.ThrowArgumentOutOfRangeExceptionIfNegative(initialCapacity, nameof(initialCapacity));
        ...
        {
            ThrowHelper.ThrowArgumentNullExceptionIfNull(in items, nameof(items));
        ...
        {
            ThrowHelper.ThrowArgumentNullExceptionIfNull(in elements, nameof(elements));
        ...
        public void Clear()
        {
            if (TypeHelper<(TElement, TPriority)>.IsReferenceOrContainsReferences)
            {
        ...
        {
            ThrowHelper.ThrowArgumentOutOfRangeExceptionIfNegative(capacity, nameof(capacity));
                ...
                ICollection
        {
            ...
            {
                ThrowHelper.ThrowArgumentNullExceptionIfNull(in array, nameof(array));
            ...
            IEnumerator<(TElement Element, TPriority Priority)> IEnumerable<(
                ...
                _queue.Count == 0 ? Enumerable.Empty<(TElement, TPriority)>().GetEnumerator() : GetEnumerator();
