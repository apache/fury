...
/// <summary>
/// Concurrent edition of <see cref="ObjectPool{T}"/>.
/// </summary>
/// <typeparam name="T">
...
internal class ConcurrentObjectPool<T>
    where T : class
{
    private readonly Func<ConcurrentObjectPool<T>, T> _factory;
    ...
    /// <summary>
    /// Creates an instance of <see cref="ConcurrentObjectPool{T}"/>.
    /// </summary>
    public ConcurrentObjectPool(Func<ConcurrentObjectPool<T>, T> factory)
    ...
    /// </param>
    public ConcurrentObjectPool(Func<ConcurrentObjectPool<T>, T> factory, int maximumRetained)
    {
